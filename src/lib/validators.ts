...
export namespace Validators {
  ...
  export const checkIfMethodsWithReponseTYpeAlowed = (methods: Models.MethodConfig[], current: Models.MethodConfig) => {
  ...
  // TODO
  export const validateClassFunctions = (controllers: any[], entities: any[], proviers: any[], repositories: any[]) => {
