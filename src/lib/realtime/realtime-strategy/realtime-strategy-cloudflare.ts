...
// TODO create some kind of implementation of realtime in cloudflare
// use pulling
 ...
 */
export class RealtimeStrategyCloudflareMock extends RealtimeStrategy {
  //#region toString
  toString(): string {
    return 'cloudflare mock';
  }
  //#endregion
