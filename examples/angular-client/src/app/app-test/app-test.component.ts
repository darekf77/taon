...
export class AppTestComponent implements OnInit {
  ...
  constructor(
    ...
    // child.saySomething().received.observable.subscribe(data => console.log('child:', data.body.text));
    // child2.saySomething2().received.observable.subscribe(data => console.log('child2:', data.body.text));
